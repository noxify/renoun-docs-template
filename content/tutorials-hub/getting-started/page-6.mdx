...
description: "Documentation for Getting Started Page 6 in tutorials-hub"
...
This is page 6 in the tutorials-hub collection under the getting-started category.
