...
description: "Documentation for Getting Started Page 6 in security-guides"
...
This is page 6 in the security-guides collection under the getting-started category.
