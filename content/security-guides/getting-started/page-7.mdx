...
description: "Documentation for Getting Started Page 7 in security-guides"
...
This is page 7 in the security-guides collection under the getting-started category.
