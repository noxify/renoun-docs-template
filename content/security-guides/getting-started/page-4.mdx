...
description: "Documentation for Getting Started Page 4 in security-guides"
...
This is page 4 in the security-guides collection under the getting-started category.
