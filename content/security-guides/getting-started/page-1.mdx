...
description: "Documentation for Getting Started Page 1 in security-guides"
...
This is page 1 in the security-guides collection under the getting-started category.
