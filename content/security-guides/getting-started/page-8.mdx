...
description: "Documentation for Getting Started Page 8 in security-guides"
...
This is page 8 in the security-guides collection under the getting-started category.
