...
description: "Documentation for Examples Page 1 in performance-docs"
category: "examples"
order: 71
---
...
This is page 71 in the performance-docs collection under the examples category.
...
```javascript
// Example for Examples Page 1
function examplespage1Example() {
  const config = {
    name: "Examples Page 1",
...
// Usage
const example = examplespage1Example();
console.log(example);
```
...
```typescript
import { ExamplesPage1 } from './examples-page-1';

const instance = new ExamplesPage1({
  collection: "performance-docs",
  category: "examples"
});
...
const instance = new ExamplesPage1(options);
```
...
Initializes the examples page 1 with optional configuration.
