---
title: "Guides Page 2"
description: "Documentation for Guides Page 2 in performance-docs"
category: "guides"
order: 17
---
...
This is page 17 in the performance-docs collection under the guides category.
...
```javascript
// Example for Guides Page 2
function guidespage2Example() {
  const config = {
    name: "Guides Page 2",
...
// Usage
const example = guidespage2Example();
console.log(example);
```
...
```typescript
import { GuidesPage2 } from './guides-page-2';

const instance = new GuidesPage2({
  collection: "performance-docs",
  category: "guides"
});
...
const instance = new GuidesPage2(options);
```
...
Initializes the guides page 2 with optional configuration.
