...
description: "Documentation for Getting Started Page 1 in performance-docs"
...
This is page 1 in the performance-docs collection under the getting-started category.
...
```javascript
// Example for Getting Started Page 1
function gettingstartedpage1Example() {
  const config = {
...
// Usage
const example = gettingstartedpage1Example();
console.log(example);
```
...
```typescript
import { GettingStartedPage1 } from './getting-started-page-1';

const instance = new GettingStartedPage1({
  collection: "performance-docs",
  category: "getting-started"
});
...
const instance = new GettingStartedPage1(options);
```
...
Initializes the getting started page 1 with optional configuration.
